...
import useProductDetail from '../p/hooks/useProductDetail';
          ...
          {cart.map((item) => (
            <TableRow key={item.id}>
              ...
              <TableCell align="right">
                {' '}
                <Button onClick={handleDeleteItem} type="submit" variant="contained" color="primary" style={{ width: '50px' }} size="small">
                  Remove
                </Button>
              </TableCell>
            </TableRow>
